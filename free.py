...
#------------------[ Finished User Agent ]-------------------#
try:
    version = requests.get("https://raw.githubusercontent.com/MAFIA-143/Server/refs/heads/main/Version.txt").text
except:
...
sys.stdout.write('\x1b]2; MR-MAFIA > M1 \x07')
...
TrialExist=""
logo=(f"""\033[1;37m
{gas}  .88b  d88.  .d8b.  d88888b d888888b  .d8b.  
{gas}  88'YbdP`88 d8' `8b 88'       `88'   d8' `8b 
{gas}  88  88  88 88ooo88 88ooo      88    88ooo88 
{gas}  88  88  88 88~~~88 88~~~      88    88~~~88 
{gas}  88  88  88 88   88 88        .88.   88   88 
{gas}  YP  YP  YP YP   YP YP      Y888888P YP   YP 
\033[1;34m─────────────────────────────────────────────
\033[1;32m[\033[1;31m–\033[1;32m] AUTHOR   : MR-MAFIA
\033[1;32m[\033[1;31m–\033[1;32m] FACEBOOK : YOUCEF YT
\033[1;32m[\033[1;31m–\033[1;32m] GITHUB   : MAFIA-143
\033[1;34m─────────────────────────────────────────────
\033[1;32m[\033[1;31m–\033[1;32m] BEST ALGRIA CRACK MAFIA WORLD 🗽
\033[1;34m─────────────────────────────────────────────
...
def approval():
  ...
  try:
    ...
    if 'Napv' in sec:
      boos = random.choice([P, M, H, K, B, U, O, N])
      print(f" \033[1;32m[\033[1;31m√\033[1;32m] YOUR KEY 🔐 \033[1;37m : {boos}MAFIA+\033[1;32m"+sec.replace('Napv',''))
      print('\033[1;34m─────────────────────────────────────────────')
